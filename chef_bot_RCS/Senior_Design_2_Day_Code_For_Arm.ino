...
const int stepper_delay[] = {1000000 / 800}; // 800 pulses per second
const int stepper_maxsteps[] = {8000}; 
...
void loop() {
  ...
  coordinate_move(20,20,6,0);
  coordinate_move(-20,12,6,0);
  coordinate_move(-5,-20,0,0);
  coordinate_move(30,12,6,0);  
  coordinate_move(0,-9,6,0);
  coordinate_move(-8,-20,0,0);
  coordinate_move(30,12,6,0);  
  coordinate_move(0,-9,6,0);
